...
tim <- AAPL.Vol~VXAPLCLS+AMZN.PVol+(GOOG.PVol*GSPC.PVol*AMZN.PVol )+Date+Date2+AMZN.PVol+AMZN.PVol2+GOOG.PVol+GOOG.PVol2+GOOG.PVol3+GSPC.PVol5+GSPC.Close+VXAZNCLS
...
model <- train(tim, data, method = "lm", trControl = train_control)
