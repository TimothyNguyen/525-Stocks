...
#combo_mod <- lm(AAPL.Vol~VXAPLCLS+AMZN.PVol+interactterm+Date+Date2+AMZN.PVol+AMZN.PVol2+GOOG.PVol+GOOG.PVol2+GOOG.PVol3+GSPC.PVol2+GSPC.PVol3+GSPC.PVol4+GSPC.PVol5+GSPC.Close+GSPC.Close2+GSPC.Close3+VXAZNCLS)
combo_mod <- lm(AAPL.Vol~VXAPLCLS+(GOOG.PVol*AMZN.PVol)+Date+Date2+AMZN.PVol2+GOOG.PVol+GOOG.PVol2+GOOG.PVol3+GSPC.Close+GSPC.Close2+GSPC.Close3+VXAZNCLS)
```
...
model <- train(AAPL.Vol~VXAPLCLS+AMZN.PVol+GOOG.PVol*GSPC.PVol*AMZN.PVol +Date+Date2+AMZN.PVol+AMZN.PVol2+GOOG.PVol+GOOG.PVol2+GOOG.PVol3+GSPC.PVol2+GSPC.PVol3+GSPC.PVol4+GSPC.PVol5+GSPC.Close+GSPC.Close2+GSPC.Close3+VXAZNCLS, data, method = "lm", trControl = train_control)
#model = train(AAPL.Vol~VXAPLCLS+(GOOG.PVol*AMZN.PVol)+Date+Date2+AMZN.PVol2+GOOG.PVol+GOOG.PVol2+GOOG.PVol3+GSPC.Close+GSPC.Close2+GSPC.Close3+VXAZNCLS, data, method = "lm", trControl = train_control)
